...
huggingface-cli facebook/dinov2-giant  --local-dir pretrained/tencent/Hunyuan3D21/dinov2-giant
wget -O "pretrained/tencent/Hunyuan3D21/RealESRGAN_x4plus.pth" "https://github.com/xinntao/Real-ESRGAN/releases/download/v0.1.0/RealESRGAN_x4plus.pth"
